...
async function postTransfer(req, res) {
  ...
  verifyJwt(req, res, async function (userId) {
    ...
    if (!properPermission) {
      return sendFailure(res, true, {
        info: "You don't have the permission to perform on this budget",
      });
    }
    ...
    try {
      ...
      return sendFailure(res, true, {
        info: 'Cannot create new Transaction',
      });
    }
    ...
    if (senderId !== receiverId) {
      try {
        ...
        return sendFailure(res, true, {
          info: 'Cannot save or update total exchange',
        });
      }
    }
    ...
    try {
      ...
      return sendFailure(res, true, {
        info: 'Cannot update the transaction',
      });
    }
    return sendSuccess(res, true, transaction);
  });
